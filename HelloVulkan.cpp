...
private:
	...
	void createDepthResources() {
		...
		std::tie(depthImage, depthImageMemory) = createImage({gli::format(depthFormat),
	...
	vk::Format findSupportedFormatOf(const std::vector<vk::Format>& candidates,
									 vk::ImageTiling tiling,
